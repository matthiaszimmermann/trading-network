...
public class NetworkTablePage extends AbstractPageWithTable<Table> {
  ...
  public static final String CONTRACT_ABI_FILE = "/Users/matthiaszimmermann/Documents/private/github/trading-network/Solidity/src/main/resources/OrderBook.abi";
  ...
  public class Table extends AbstractTable {
    ...
    public class ContractInfoMenu extends AbstractMenu {
      ...
      protected void execAction() {
        ...
        web3code.append(String.format(callTemplate, "getNumberOfSellOrders()"));
